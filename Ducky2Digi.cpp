...
int main(){
    ...
    //Eye-candy
    printf("\n\n\n    d8888b. db    db  .o88b. db   dD db    db .d888b. d8888b. d888888b  d888b  d888888b \n");
    printf("    88  `8D 88    88 d8P  Y8 88 ,8P' `8b  d8' VP  `8D 88  `8D   `88'   88' Y8b   `88'   \n");
    printf("    88   88 88    88 8P      88,8P    `8bd8'     odD' 88   88    88    88         88    \n");
    printf("    88   88 88    88 8b      88`8b      88     .88'   88   88    88    88  ooo    88    \n");
    printf("    88  .8D 88b  d88 Y8b  d8 88 `88.    88    j88.    88  .8D   .88.   88. ~8~   .88.   \n");
    printf("    Y8888D' 'Y8888P'  `Y88P' YP   YD    YP    888888D Y8888D' Y888888P  Y888P  Y888888P \n\n\n");

    cout<<endl;
    cout<<"Welcome To Ducky2Digi, The Easy DuckyScript To Digispark Payload Converter By Nakshatra Ranjan Saha (OCEAN OF ANYTHNG)\n"<<endl;

    //Ask user to enter path to file to be converted
    string dir;
    cout<<"Enter the path of the file Which You Want To Convert be converted:"<<endl;
    cin>>dir;
    ...
    {
        cout<<"The File You supplied is empty"<<endl;
        return -1;
    ...
    ofstream fileout;
    fileout.open ("DigiSpark Payload.txt");
